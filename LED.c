...
char MYFILE1[]="./chi-LED/LED1.dat";
char MYFILE2[]="./chi-LED/LED2.dat";
char MYFILE31[]="./chi-LED/LED31.dat";
char MYFILE22[]="./chi-LED/LED22.dat";
char MYFILE30[]="./chi-LED/LED30.dat";
char MYFILE40[]="./chi-LED/LED40.dat";
char MYFILE50[]="./chi-LED/LED50.dat";
char MYFILE60[]="./chi-LED/LED60.dat";
char MYFILE70[]="./chi-LED/LED70.dat";
char MYFILE80[]="./chi-LED/LED80.dat";
char MYFILE90[]="./chi-LED/LED90.dat";
char MYFILE100[]="./chi-LED/LED100.dat";
 ...
 ************************************************************************************************************/
  double complex u(int i, int j){
    int bf = 0;
    double Lth13 = th13;//asin(sin(th13)/(sqrt(L(a3[bf],b[bf],e[0][bf]))));
    double Lth12 = th12;//asin(cos(th13)*sin(th12)/(sqrt(L(a2[bf],b[bf],d[0][bf]))*cos(Lth13)));
    double Lth23 = th23;//asin(cos(th13)*sin(th23)/(sqrt(L(a3[bf],b[bf],e[0][bf]))*cos(Lth13)));
...
{ 
  ...
  char* MYFILE="/Users/gstenico/Desktop/prob_LED.dat"; 
  FILE* stream;
...
/*   double s;
  for(s=1; s<10;s=s+0.01){
    double resul=glbVacuumProbability(2,1,+1,s,1300);
    fprintf(stream,"%f %f \n",s,resul);}

    printf("%f %f \n",creal(conj(sum12(0,0,0.6,0.6))),cimag(sum12(0,0,0.6,0.6)));*/
  
  /* int k;
  for(k=0; k<2030;k++){
    double resul=L(a[k],b[k],c[20][k]);
    fprintf(stream,"%d %f \n",k,resul);}*/
