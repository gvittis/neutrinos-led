...
BIN = LED_inv LED-3+1 LED 3+1 example-tour example-static example1 example2 example3 example4 example5 example6 decay
OBJ = LED_inv.o LED-3+1.o LED.o 3+1.o example-tour.o example-tour-s.o example1.o example2.o example3.o example4.o \
      example5.o example6.o myio.o decay.o

all: $(BIN)

decay: decay.o myio.o
	gcc -fPIC decay.o myio.o -o decay $(LDFLAGS) $(local_LDFLAGS)

LED_inv: LED_inv.o myio.o
	gcc LED_inv.o myio.o -o LED_inv $(LDFLAGS) $(local_LDFLAGS)

LED-3+1: LED-3+1.o myio.o
	gcc LED-3+1.o myio.o -o LED-3+1 $(LDFLAGS) $(local_LDFLAGS)

LED: LED.o myio.o
	gcc LED.o myio.o -o LED $(LDFLAGS) $(local_LDFLAGS)

3+1: 3+1.o myio.o
	gcc 3+1.o myio.o -o 3+1 $(LDFLAGS) $(local_LDFLAGS)
